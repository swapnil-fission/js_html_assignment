        ...
        if (xhr.status == 200 && xhr.readyState == 4) {
            ...
            if (d.length > 0) {
                ...
                d.forEach((u) => {
                    temp += "<tr>";
                    temp += "<td>" + u.id + "</td>";
                    temp += "<td class='a' id=n" + u.id + ">" + u.name + "</td>";
                    temp += "<td class='b' id=e" + u.id + ">" + u.expiryDate + "</td>";
                    temp += "<td class='c' id=s" + u.id + ">" + u.status + "</td><td><button class='btn-outline-warning edit' id=edit" + u.id + " value='edit' onclick='edit_row(" + u.id + ")'>Edit</button></td><td><button class='btn-danger' onclick='deleteData(" + u.id + ")'>Delete</button></td></tr>";
                });
